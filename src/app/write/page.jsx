    ...
    <div className={styles.container}>
      ...
      {isAllowedUser && (
        <label className={styles.featureLabel}>
          <input
            ...
            type="checkbox"
            checked={isFeatured}
            onChange={handleIsFeaturedChange}></input>
          <p className={styles.featureText}>{`Make this Post Featured on Editor's Choice`}</p>
        </label>
      )}
      {loading && (
      ...
      {media && (
        <div className={styles.imageContainer}>
          <Image src={media} className={styles.image} width={300} height={300} alt="" />
        </div>
      )}

      <div className={styles.editor}>
        <button className={styles.button} onClick={() => setOpen(!open)}>
          <Image src="/plus.svg" alt="" className={styles.plus} width={16} height={16} />
        </button>
        {open && (
